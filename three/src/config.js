// Ingredient placements derived from godot/Scenes/3D_scene/global_species_view.tscn.
// position = parent_node_pos + local_pos (rotation/scale simplified).
...
export const INGREDIENTS = [
  {
    ...
    key: "ACORN",
    model: "acorn",
    card: "assets/cards/acorn.jpg",
    position: [3.486, 0, -2.214],
    scale: 1.565,
    rotY: 0,
  },
  {
    ...
    key: "CHANTERELLE",
    model: "chanterelle",
    card: "assets/cards/chanterelle.jpg",
    position: [-3.668, 0, 3.557],
    scale: 1.565,
    rotY: 0.5,
  },
  {
    ...
    key: "FAVA",
    model: "fava",
    card: "assets/cards/fava.jpg",
    position: [0.304, 2.268, 3.781],
    scale: 1.5,
    rotY: 0.8,
  },
  {
  ...
  },
  {
    ...
    key: "ELDERFLOWER",
    model: "elderflower",
    card: "assets/cards/elderflower.jpg",
    position: [2.889, 0.277, 3.496],
    scale: 1.565,
    rotY: 1.2,
  },
  {
    ...
    key: "BORAGE",
    model: "borage",
    card: "assets/cards/borage.jpg",
    position: [-2.763, 2.332, 0.435],
    scale: 1.5,
    rotY: 0.6,
  },
  {
    ...
    key: "FIG",
    model: "fig",
    card: "assets/cards/fig.jpg",
    position: [-0.360, -1.698, 4.164],
    scale: 2.0,
    rotY: 0.3,
  },
  {
    ...
    key: "PURPLE_BASIL",
    model: "purple_basil",
    card: "assets/cards/purple_basil.jpg",
    position: [3.676, -1.942, 0.868],
    scale: 1.565,
    rotY: 1.5,
  },
  {
  ...
  },
  {
    ...
    key: "PENNYWORT",
    model: "pennywort",
    card: "assets/cards/pennywort.jpg",
    position: [-0.986, 0.528, -3.540],
    scale: 1.0,
    rotY: 1.9,
  },
  {
    ...
    key: "DANDELION",
    model: "dandelion",
    card: "assets/cards/dandelion.jpg",
    position: [-1.264, -1.988, -3.371],
    scale: 1.565,
    rotY: 0.9,
  },
];

// Companion ring layout (same as godot bitzfarmsspawner).
export const RING_RADII = [5.0, 10.0, 15.0, 20.0];
export const RING_CAPACITIES = [7, 20, 40, 80];
export const MAX_CONCURRENT_FETCHES = 4;
export const SPAWN_INTERVAL_MS = 20;

// Background removal service endpoint.
export const REMBG_BASE = (() => {
  // Same-origin when served behind the EAT.BITZ gateway; falls back to prod for local dev.
  if (typeof window !== "undefined") {
    const host = window.location.hostname;
    if (host && host !== "localhost" && host !== "127.0.0.1") {
      return window.location.origin + "/rembg";
    }
  }
  return "https://eat.bitz.tools/rembg";
})();

// Curated quest -> species index list (see godot/Scripts/companions.gd).
